      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold text-white mb-4">Ken Paolo DAGBA</h3>
            <p className="mb-4 text-slate-400">
              Développeur Full Stack & Analyste Programmeur passionné par la création d&apos;applications performantes et modernes.
            </p>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-sm text-slate-500 mt-2 md:mt-0">Designed & Developed with ❤️</p>
        </div>
      </div>
    </footer>
  );
...
function SocialIcon({ href, children, ...props }: { href: string, children: React.ReactNode, [key: string]: any }) {
  return (
    <a 
      href={href}
      target="_blank"
