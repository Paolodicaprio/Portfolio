      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="heading">Intéressé par une Collaboration?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="space-y-6">
                ...
                {/* Social Media */}
                <div className="pt-6">
                  <h3 className="font-semibold text-lg mb-4">Retrouvez-moi sur</h3>
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-6">
                Pour plus de détails sur mes services ou pour discuter d&apos;une potentielle collaboration, n&apos;hésitez pas à me contacter directement.
              </p>
              <Link 
                href="/contact"
